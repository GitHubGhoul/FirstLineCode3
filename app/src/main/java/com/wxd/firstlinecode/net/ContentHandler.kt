...
class ContentHandler : DefaultHandler() {
    ...
    Attributes) {
        // 记录当前节点名
        nodeName = localName
        Log.e("ContentHandler", "uri is $uri")
        Log.e("ContentHandler", "localName is $localName")
        Log.e("ContentHandler", "qName is $qName")
        Log.e("ContentHandler", "attributes is $attributes")
    }
